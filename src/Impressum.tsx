    ...
    <div className="app">
      <section className="section">
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          ...
          <h2 style={{ fontSize: '1.5rem', color: 'var(--dark)' }}>Angaben zum Betreiber</h2>
          <p>
          ...
          <h2 style={{ fontSize: '1.5rem', color: 'var(--dark)', marginTop: '2rem' }}>Vertreten durch</h2>
          <p>Thomas Wiedmann</p>

          <h2 style={{ fontSize: '1.5rem', color: 'var(--dark)', marginTop: '2rem' }}>Kontakt</h2>
          <p>
            <strong>Telefon:</strong> 06181-2997144<br />
            <strong>E-Mail:</strong> office@entwicklungs-werkstatt.com
          </p>

          <h2 style={{ fontSize: '1.5rem', color: 'var(--dark)', marginTop: '2rem' }}>Umsatzsteuer-ID</h2>
          <p>
            Umsatzsteuer-Identifikationsnummer gemäß §27a Umsatzsteuergesetz:<br />
            <strong>DE461433759</strong>
          </p>

          <h2 style={{ fontSize: '1.5rem', color: 'var(--dark)', marginTop: '2rem' }}>Verbraucherstreitbeilegung / Universalschlichtungsstelle</h2>
          <p>
